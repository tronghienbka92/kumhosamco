...
namespace Nop.Web.Extensions
{
    public static class MappingExtensions
    {
        ...
        public static HanhTrinhGiaVeThoiGianModel toModel(this HanhTrinhGiaVeThoiGian nvfrom,ILocalizationService _localizationService)
        {
            var nvto = new HanhTrinhGiaVeThoiGianModel();
            if (nvfrom == null)
                return nvto;
            nvto.Id = nvfrom.Id;
            nvto.HanhTrinhId = nvfrom.HanhTrinhId;
            nvto.TenDiemDi = nvfrom.DiemDi.TenDiemDon;
            nvto.TenDiemDen = nvfrom.DiemDen.TenDiemDon;
            nvto.TuNgay = nvfrom.TuNgay;
            nvto.DenNgay = nvfrom.DenNgay;
            nvto.GiaVe = nvfrom.GiaVe;
            nvto.isDoLa = nvfrom.isDola;
            return nvto;
        }
        ...
        public static VeXeItemModel toModel(this VeXeItem entity, ILocalizationService localizationService)
        {
            ...
            {
                model.TenChang = string.Format("{0} -> {1}", entity.changgiave.DiemDi.TenDiemDon, entity.changgiave.DiemDen.TenDiemDon);
            }
