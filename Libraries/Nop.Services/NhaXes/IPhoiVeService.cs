...
namespace Nop.Services.NhaXes
{
    public partial interface IPhoiVeService
    {
        ...
        void InsertPhoiVeNote(PhoiVeNote item);
        ...
        /// </summary>
        /// <param name="item"></param>
        string ThanhToanGiaoVe(PhoiVe item);
        string GanSeriVeBoSung(PhoiVe item);
        ...
        string NhaXeThanhToanGiuChoPhoiVeTheoChuyen(int NhaXeId, int ChuyenDiId, int ChangId, string SessionId, int NguoiDatVeId, bool DaThanhToan,int DaiLyId, int CustomerId, string GhiChu,string ViTriLen,string ViTriXuong, bool IsForKid);
        ...
        List<PhoiVe> GetPhoiVeByVanPhongId(int VanPhongId, DateTime NgayBan);
        ...
        List<ThongKeItem> GetLoaiVeSeriByNhanVienId(int NhanVienId,DateTime NgayBan);
        List<ThongKeItem> GetLoaiVeSeriByXeId(int NhanVienId, DateTime NgayBan);
