...
namespace Nop.Services.NhaXes
{
    public partial class BaoCaoService:IBaoCaoService
    {
        ...
        #region Xe xuat ben
        public virtual List<HistoryXeXuatBen> GetXeXuatBens(int NhaXeId, int XeVanChuyenId = 0,  int[] laiphuxeids = null, DateTime? TuNgay = null, DateTime? DenNgay = null,int[] hanhtrinhIds = null)
        {
            if (TuNgay.HasValue)
