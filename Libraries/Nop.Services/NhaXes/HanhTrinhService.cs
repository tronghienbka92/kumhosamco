...
namespace Nop.Services.NhaXes
{
    public class HanhTrinhService : IHanhTrinhService
    {
        ...
        private readonly IRepository<HanhTrinhGiaVeThoiGian> _hanhtrinhgiavethoigianRepostory;
            ...
            )
        {
            ...
            this._hanhtrinhgiavethoigianRepostory = hanhtrinhgiavethoigianRepository;
        }
        #region Diem Don
        ...
        public virtual PagedList<HanhTrinh> GetAllHanhTrinh(int NhaXeId = 0, string _keyword = "",
         ...
         int pageSize = int.MaxValue)
        {
            var query = _HanhTrinhRepository.Table.Where(c=>!c.isDelete);
            if (!String.IsNullOrWhiteSpace(_keyword))
        ...
        public virtual bool InsertHanhTrinh(HanhTrinh _item)
        {
            ...
            var existitem = _HanhTrinhRepository.Table.Where(c => c.MaHanhTrinh == _item.MaHanhTrinh).Count();
            if (existitem == 0)
            {
        ...
        #endregion
        #region LichTrinh
        public virtual PagedList<LichTrinh> GetAllLichTrinh(int NhaXeId = 0, int HanhTrinhId = 0,int LoaiXeId=0,
         int pageIndex = 0,
         int pageSize = int.MaxValue)
        {
        ...
        public List<NguonVeXe> GetNguonVeXeByLichTrinhId(int NhaXeId, int LichTrinhId)
        {
            var query = _NguonVeXeRepository.Table.Where(c => c.NhaXeId == NhaXeId);
            if (LichTrinhId > 0)
                query = query.Where(c => c.LichTrinhId == LichTrinhId);
            return query.ToList();
        }
        public NguonVeXe GetNguonVeXeByloaixe(int HanhTrinhId,DateTime GioDi,int LoaiXeId)
        {
            var query = _NguonVeXeRepository.Table.Where(c => !c.isDelete && c.ParentId == 0
                ...
                && c.ThoiGianDi.Minute==GioDi.Minute && c.ToWeb && c.HienThi);
            if (query.Count() == 0)
                return null;
        ...
        public List<HanhTrinhGiaVeThoiGian> GetAllHanhTrinhGiaVeThoiGian(int NhaXeId,int HanhTrinhId = 0)
        {
            var query = _hanhtrinhgiavethoigianRepostory.Table;
            query = query.Where(c => c.NhaXeId == NhaXeId);
            if (HanhTrinhId > 0)
                query = query.Where(c => c.HanhTrinhId == HanhTrinhId);
            return query.ToList();
        }
        public HanhTrinhGiaVeThoiGian GetHanhTrinhGiaVeThoiGianById(int Id)
        {
            return _hanhtrinhgiavethoigianRepostory.GetById(Id);
        }
        public void InsertHanhTrinhGiaVeThoiGian(HanhTrinhGiaVeThoiGian item)
        {
            if (item == null)
                throw new ArgumentNullException("HanhTrinhGiaVeThoiGian");
            _hanhtrinhgiavethoigianRepostory.Insert(item);
        }
        public void UpdateHanhTrinhGiaVeThoiGian(HanhTrinhGiaVeThoiGian item)
        {
            if (item == null)
                throw new ArgumentNullException("HanhTrinhGiaVeThoiGian");
            _hanhtrinhgiavethoigianRepostory.Update(item);
        }
        public void DeleteHanhTrinhGiaVeThoiGian(HanhTrinhGiaVeThoiGian item)
        {
            if (item == null)
                throw new ArgumentNullException("HanhTrinhGiaVeThoiGian");
            _hanhtrinhgiavethoigianRepostory.Delete(item);
        }
        #endregion
    }
}
