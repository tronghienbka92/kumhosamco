...
namespace Nop.Services.NhaXes
{
    public partial interface IGiaoDichKeVeXeService
    {
        ...
        void InsertGiaoDichKeVeLoaiVe(GiaoDichKeVeLoaiVe item);
        ...
        List<GiaoDichKeVeMenhGia> GetTonGiaoDichKeVeMenhGia(int NhanVienId, int MenhGiaVeId, bool isVeDi,int VanPhongId, int LoaiVeId,int HanhTrinhId,int ChangId);
        ...
        void DeleteMauVe(QuanLyMauVeKyHieu item);
        ...
        List<ChuyenDiTaiChinh> GetChuyenDiTaiChinhByVanPhongId(int VanPhongId, DateTime NgayDi);
