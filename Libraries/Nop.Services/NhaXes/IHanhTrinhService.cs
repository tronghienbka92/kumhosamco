...
namespace Nop.Services.NhaXes
{
    public partial interface IHanhTrinhService
    {
        ...
        #endregion
        #region LichTrinh
        PagedList<LichTrinh> GetAllLichTrinh(int NhaXeId = 0, int HanhTrinhId = 0,int LoaiXeId=0,
         int pageIndex = 0,
         int pageSize = int.MaxValue);
       ...
       // List<NguonVeXe> GetAllNguonVeXe(int NhaXeId = 0, int LichTrinhId = 0, int HanhTrinhId = 0,int DiemDenGocId=0);
        ...
        List<NguonVeXe> GetNguonVeXeByLichTrinhId(int NhaXeId, int LichTrinhId);
        ...
        List<HanhTrinhGiaVeThoiGian> GetAllHanhTrinhGiaVeThoiGian(int NhaXeId, int HanhTrinhId = 0);
        HanhTrinhGiaVeThoiGian GetHanhTrinhGiaVeThoiGianById(int Id);
        void InsertHanhTrinhGiaVeThoiGian(HanhTrinhGiaVeThoiGian item);
        void UpdateHanhTrinhGiaVeThoiGian(HanhTrinhGiaVeThoiGian item);
        void DeleteHanhTrinhGiaVeThoiGian(HanhTrinhGiaVeThoiGian item);
        #endregion
    }
}
