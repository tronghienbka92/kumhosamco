...
namespace Nop.Services.ExportImport
{
    ...
    public partial class ExportManager : IExportManager
    {
        ...
        public virtual void ExportBaoCaoDoanhThu(Stream stream, HanhTrinhDateItem[,] DoanhThuLuot, List<String> listDayOfWeek, int Thang, int Nam, int SoHanhTrinh, int SoNhan)
        {
            {
                if (stream == null)
                    throw new ArgumentNullException("stream");
                ...
                using (var xlPackage = new ExcelPackage(stream))
                {
                    ...
                    int c = 1;
                    int x = 1;
                    if(listDayOfWeek.Count()>0)
                    {
                        row = 5;
                        worksheet.Cells["A5:A6"].Merge = true;
                        worksheet.Cells["A5:A6"].Value = "Tên tuyến";
                        worksheet.Cells["A5:A6"].Style.VerticalAlignment = ExcelVerticalAlignment.Center;
                        worksheet.Cells["A5:A6"].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                        x++;
                        worksheet.Cells["B5:C5"].Merge = true;
                        worksheet.Cells["B5:C5"].Value = "Thứ";
                        worksheet.Cells["B5:C5"].Style.VerticalAlignment = ExcelVerticalAlignment.Center;
                        worksheet.Cells["B5:C5"].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;

                        worksheet.Cells["B6:C6"].Merge = true;
                        worksheet.Cells["B6:C6"].Value = "Ngày";
                        worksheet.Cells["B6:C6"].Style.VerticalAlignment = ExcelVerticalAlignment.Center;
                        worksheet.Cells["B6:C6"].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                        x +=2;   
                        for (int k = 0; k < listDayOfWeek.Count(); k++)
                        {
                            //worksheet.Cells[x, x + 1].Merge = true;
                            worksheet.Cells[row, x, row, x + 1].Merge = true;
                            worksheet.Cells[row, x].Value = listDayOfWeek[k];
                            x += 2;
                        }
                        row++;
                    ...
                    for (int i = 0; i < SoHanhTrinh + 1; i++)
                    {
                        ...
                        for (int j = 0; j < SoNhan + 3; j++)
                        {
                            if (i == 0 && j > 0 && j < SoNhan + 1)
                            {

                                worksheet.Cells[i + 6, col].Value = DoanhThuLuot[0, j].NgayDi;
                            }
                            if (j == 0 && i > 0)
                            {
                                worksheet.Cells["A" + row + ":A" + (row + 6)].Merge = true;
                                worksheet.Cells["A" + row + ":A" + (row + 6)].Style.VerticalAlignment = ExcelVerticalAlignment.Center;
                                worksheet.Cells["A" + row + ":A" + (row + 6)].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                                worksheet.Cells["A" + row + ":A" + (row + 6)].Style.Fill.PatternType = ExcelFillStyle.Solid;

                                if (c % 2 == 0)
                                    worksheet.Cells["A" + row + ":A" + (row + 6)].Style.Fill.BackgroundColor.SetColor(Color.FromArgb(130, 130, 130));
                                else
                                    worksheet.Cells["A" + row + ":A" + (row + 6)].Style.Fill.BackgroundColor.SetColor(Color.FromArgb(238, 203, 173));
                                worksheet.Cells[row, col].Value = DoanhThuLuot[i, j].TenHanhTrinh;
                                //worksheet.Cells["A" + row + ":A" + (row + 3)]
                                ...
                                worksheet.Cells["B" + (row + 1) + ":C" + (row + 1)].Merge = true;
                                worksheet.Cells[row + 1, col + 1].Value = "Số khách";
                                worksheet.Cells[row + 1, col + 1].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                worksheet.Cells[row + 1, col + 1].Style.Fill.BackgroundColor.SetColor(Color.FromArgb(238, 203, 173));

                                worksheet.Cells["B" + (row + 2) + ":C" + (row + 2)].Merge = true;
                                worksheet.Cells[row + 2, col + 1].Value = "Số khách TB";
                                worksheet.Cells[row + 2, col + 1].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                worksheet.Cells[row + 2, col + 1].Style.Fill.BackgroundColor.SetColor(Color.FromArgb(238, 203, 173));

                                worksheet.Cells["B" + (row + 3) + ":B" + (row + 6)].Merge = true;
                                worksheet.Cells[row + 3, col + 1].Value = "Doanh thu";
                                worksheet.Cells[row + 3, col + 1].Style.VerticalAlignment = ExcelVerticalAlignment.Center;
                                worksheet.Cells[row + 3, col + 1].Style.HorizontalAlignment = ExcelHorizontalAlignment.Center;
                                worksheet.Cells[row + 3, col + 1].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                worksheet.Cells[row + 3, col + 1].Style.Fill.BackgroundColor.SetColor(Color.FromArgb(99, 184, 255));

                                worksheet.Cells[row + 3, col + 2].Value = "Vé quầy";
                                worksheet.Cells[row + 3, col + 2].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                worksheet.Cells[row + 3, col + 2].Style.Fill.BackgroundColor.SetColor(Color.FromArgb(99, 184, 255));

                                worksheet.Cells[row + 4, col + 2].Value = "Vé đại lý";
                                worksheet.Cells[row + 4, col + 2].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                worksheet.Cells[row + 4, col + 2].Style.Fill.BackgroundColor.SetColor(Color.FromArgb(99, 184, 255));

                                worksheet.Cells[row + 5, col + 2].Value = "Vé đi ngay";
                                worksheet.Cells[row + 5, col + 2].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                worksheet.Cells[row + 5, col + 2].Style.Fill.BackgroundColor.SetColor(Color.FromArgb(99, 184, 255));

                                worksheet.Cells[row + 6, col + 2].Value = "Vé Total";
                                worksheet.Cells[row + 6, col + 2].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                worksheet.Cells[row + 6, col + 2].Style.Fill.BackgroundColor.SetColor(Color.FromArgb(99, 184, 255));
                                c++;
                            }
                            if (i > 0 && j > 0 && j < SoNhan + 1)
                            {
                                ...
                                //worksheet.Cells[row + 3, col].Value = DoanhThuLuot[i, j].DoanhThu.ToString("###,###");
                                worksheet.Cells[row + 3, col].Value = DoanhThuLuot[i, j].DoanhThuVeDiTruoc.ToString("###,###");
                                worksheet.Cells[row + 4, col].Value = DoanhThuLuot[i, j].DoanhThuVeDaiLy.ToString("###,###");
                                worksheet.Cells[row + 5, col].Value = DoanhThuLuot[i, j].DoanhThuVeDiNgay.ToString("###,###");
                                worksheet.Cells[row + 6, col].Value = DoanhThuLuot[i, j].TongDoanhThu.ToString("###,###");
                    ...
                    //style header
                    string modelRangeheader = "A5:AG5";
                    var modelTableheader = worksheet.Cells[modelRangeheader];
                    modelTableheader.Style.Border.Top.Style = ExcelBorderStyle.Thin;
                    modelTableheader.Style.Border.Left.Style = ExcelBorderStyle.Thin;
                    modelTableheader.Style.Border.Right.Style = ExcelBorderStyle.Thin;
            ...
            using (var xlPackage = new ExcelPackage(stream))
            {
                ...
                for (int i = 0; i < data.Rows.Count; i++)
                {
                    ...
                    for (int j = 0; j < data.Columns.Count; j++)
                    {
                        ...
                        worksheet.Cells[row, col].Value = data.Rows[i][j].ToString();

                        col++;
                    }
                    if (addSumRight)
                    {
                        worksheet.Cells[row, col].Value = _sumright.ToString("###,###,##0");
                        worksheet.Cells[row, col].Style.Font.Bold = true;
                        col++;
                    }
                ...
                if (addSumBottom)
                {
                    ...
                    for (int j = idxColForSum; j < data.Columns.Count; j++)
                    {
                        ...
                        worksheet.Cells[row, col].Value = _sumbottom.ToString("###,###,##0");
                        worksheet.Cells[row, col].Style.Font.Bold = true;
                        col++;
                    }
                    if (addSumRight)
                    {
                        worksheet.Cells[row, col].Value = _sumallright.ToString("###,###,##0");
                        worksheet.Cells[row, col].Style.Font.Bold = true;
                    }
