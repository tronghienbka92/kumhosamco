...
namespace Nop.Core.Domain.NhaXes
{
    public class GiaoDichKeVe : BaseEntity
    {
        ...
        private ICollection<GiaoDichKeVeLoaiVe> _keveloaives;
        public virtual ICollection<GiaoDichKeVeLoaiVe> keveloaives
        {
            get { return _keveloaives ?? (_keveloaives = new List<GiaoDichKeVeLoaiVe>()); }
            protected set {_keveloaives=value;}
        }
